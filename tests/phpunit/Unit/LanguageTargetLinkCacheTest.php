...
use SIL\LanguageTargetLinkCache;
...
/**
 * @covers \SIL\LanguageTargetLinkCache
 *
 ...
 * @author mwjames
 */
class LanguageTargetLinkCacheTest extends \PHPUnit_Framework_TestCase {
	...
	public function testCanConstruct() {
		...
		$this->assertInstanceOf(
			...
			new LanguageTargetLinkCache( $cache )
		);
	}
	...
	public function testRoundtrip() {
		...
		$instance = new LanguageTargetLinkCache( new HashBagOStuff() );
	...
	public function testDeletePageLanguageToMatchAvailableCache() {
		...
		$instance = new LanguageTargetLinkCache( $cache );
		$instance->saveLanguageTargetLinksToCache( $interlanguageLink, $languageTargetLinks );
