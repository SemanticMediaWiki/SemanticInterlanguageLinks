...
Security fixes are provided for the latest major version of Semantic Interlanguage Links.
...
[private vulnerability reporting](https://github.com/SemanticMediaWiki/SemanticInterlanguageLinks/security/advisories/new).
...
Semantic Interlanguage Links is an extension to MediaWiki that builds on Semantic MediaWiki.
If the issue is actually in one of those rather than in Semantic Interlanguage Links itself,
